 ...
 */
package mg.itu.tpcustomermatthieun49.entity;
...
/**
 * Classe Entity qui représente la table Customer
 * @author Matthieu R
 */
@Entity
@Table(name = "customer")
...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "mg.itu.tpcustomermatthieun49.entity.Customer[ customerId=" + customerId + " ]";
    }
